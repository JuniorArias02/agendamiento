...
const FiltroCitas = ({ setFiltroEstado, filtroEstado, setFiltroAbierto, filtroAbierto }) => {
  return (
    <>
      ...
      {/* Panel para móvil */}
      {filtroAbierto && (
        <div className="fixed inset-0 z-50 bg-white/60 backdrop-blur-md bg-opacity-30 flex justify-end sm:hidden">
          <div className="w-64 bg-white shadow-lg h-full p-6 flex flex-col gap-4">
